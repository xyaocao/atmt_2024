...
file_paths = [
    ...
    "assignments/03/hyperparameters_tuning/batch_size20/result.txt",
    "assignments/03/hyperparameters_tuning/batch_size15/result.txt",
    "assignments/03/hyperparameters_tuning/batch_size10/result.txt",
    "assignments/03/hyperparameters_tuning/batch_size10lr0.001/result.txt"
]
...
plt.ylabel("Score")
plt.title("BLEU Scores Comparison Across Baseline and Hyper-parameters Tuning methods")
