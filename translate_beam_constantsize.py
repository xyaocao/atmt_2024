...
from seq2seq.beam_constant_size import BeamSearch, BeamSearchNode
...
def main(args):
    ...
    for i, sample in enumerate(progress_bar):
        ...
        for _ in range(args.max_len-1):
            ...
            if all(search.all_completed() for search in searches):
                break #Stop if all beams are completed
